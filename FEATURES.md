...
- **Warm-up routine** — five easy minutes, no kit: an easy walk or bike,
...
- **Sticky note** on every exercise card — seat, grip, pin — typed once,
  there next week.
- **Last time, ghosted** — under a set's loaded number, faint "last 40 × 10",
